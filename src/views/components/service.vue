<template>
  <div class="service">
    <div class="header">
        ...
        <span class="title">以客户为中心 竭诚为您服务</span>
        <span class="line"></span>
    </div>
    <div class="content">
        <div class="item">
            <div class="imgBox">
                 <img src="../../assets/home_Serve1.png" alt="">
        ...
        <div class="item">
            <div class="imgBox">
                 <img src="../../assets/home_Serve2.png" alt="">
        ...
        <div class="item">
            <div class="imgBox">
                 <img src="../../assets/home_Serve3.png" alt="">
        ...
        <div class="item">
            <div class="imgBox">
                 <img src="../../assets/home_Serve4.png" alt="">
